...
<div class="contianer-main">
    ...
    <div class="container-kanye">
        <img src="../assets/media/images/ts.jpg" alt="Kanye West">
    </div>
</div>

<div class="article">
    <div class="image2">
        <img src="../assets/media/images/KANYEWEST.jpg" alt="Description of the image" class="article-image">
    </div>
...
<div class="article2">
    <div class="image2">
        <img src="../assets/media/images/snoopie.webp" alt="Description of the image" class="article-image2">
    </div>
